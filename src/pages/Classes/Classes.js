        ...
        <Container fluid className="classesContainer">
            ...
            <Fade top distance="6%">
              ...
              <Row className="classRow">
                ...
                <ClassCard className="Python Programming" img ="../python.png" desc="Students will code a game of Rock, Paper, Scissors to gain an understanding of the fundamentals of Python programming. Following that, students will divide into smaller groups according to skill levels and design various games."></ClassCard>
